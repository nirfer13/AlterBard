...
from utilities.helpers import build_playlist_from_folder
...
class Music(commands.Cog):
            ...
            if timestamp.strftime("%a") == "Fri" and actDay != "Fri":
                ...
                for query in playlist:
                    ...
                    if query is None:
                        ...
                        try:
                            tracks: playlist[wavelink.Playable] = await wavelink.Playable.search(query)
                            print(tracks)
    ...
    async def on_wavelink_node_ready(self, node: wavelink.Node) -> None:
        ...
        fantasy_list = build_playlist_from_folder()
        ...
        for query in playlist:
            ...
            # Reconnect if player somehow got disconnected
            if not self.player.connected:
                vc: Player = await VoiceChannel.connect(cls=self.player)
            ...
            try:
                ...
                # Wavelink will treat this as a direct HTTP track URL
        ...
        # Disabled, TBD when party playlist created
